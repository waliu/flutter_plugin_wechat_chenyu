package com.jxm.flutter_plugin_wechat_chenyu.wxapi;

import android.app.Activity;
import android.content.Intent;
import android.os.Bundle;

import com.jxm.flutter_plugin_wechat_chenyu.FlutterPluginWechatChenyuPlugin;
...
public class EntryActivity extends Activity implements IWXAPIEventHandler {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    IWXAPI api = FlutterPluginWechatChenyuPlugin.api;
  ...
  public void onResp(BaseResp resp) {
    ...
    Intent intent = new Intent("Plugin.WeChat");
